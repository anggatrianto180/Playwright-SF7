...
export class AddTrainingEvent {
    ...
    constructor(page: Page) {
        ...
        this.instructorLine3Agenda = page.locator(`//tr[td[normalize-space()='2']]//input[@type='checkbox']`);
    ...
    async fillAgenda(
        ...
        await this.clickSetInstructorAgenda();
        await this.selectInstructorLine3Agenda();
        await this.clickSubmitInstructorAgenda();
    }
